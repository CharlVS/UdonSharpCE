                ...
                context.GetTypeSymbol(methodSymbol.ReturnType) == context.GetTypeSymbol(SpecialType.System_Boolean))
            {
                ...
                switch (methodSymbol.Name)
                {
                    ...
                    case "op_LessThanOrEqual":
                        ...
                        break;
                    default:
                        throw new NotSupportedException($"Operator {methodSymbol.Name} for enum is not currently supported by U#", methodSymbol.DeclaringSyntaxReferences.FirstOrDefault()?.GetSyntax()?.GetLocation());
                }

---
name: ce-runtime
description: Develop and maintain UdonSharpCE runtime libraries (Collections/ECS/Async/Net/Persistence/Procgen) in pure C# while respecting UdonSharp constraints. Use this when editing code under `Packages/com.merlin.UdonSharp/Runtime/Libraries/`.
license: MIT
metadata:
  repo: UdonSharpCE
  source: agents/ce-runtime.md
---

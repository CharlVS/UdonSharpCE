---
name: ce-test
description: Write Unity Test Framework tests for UdonSharpCE runtime and editor code. Use this when adding or updating tests under `Packages/com.merlin.UdonSharp/Tests~/`.
license: MIT
metadata:
  repo: UdonSharpCE
  source: agents/ce-test.md
---
